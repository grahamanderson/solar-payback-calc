...
//--Graham Amendments--------------------------------------------------------------
                ...
                # Process the callback function for eval
              	$this->callback=  str_replace('$this->','',$this->callback);
                # Return True and to test the eval function...
              	$this->callback .= ';return TRUE;'; 
                $this->callback = '$this->parentClass->'.$this->callback; 
  				
                # Did the function properly run?
                if (  FALSE === eval( $this->callback) ):
       				 // Error.
       				 die('Something went awry. The callback function syntax is probably incorrect ');
   				endif;
              	
   				
               	///CALL_USER_FUNC_ARRAY ...doesn't work
